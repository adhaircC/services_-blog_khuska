<div class="flex-container datos">
  <div class="flex flex-row justify-center items-center" style="padding: 20px;">
    <div class="service-card">
      <div class="banner">
        ...
        <h1 style="margin:auto; font-size:3rem; color:white;">Plan A</h1>
      </div>

      <div class="servicio">
        <h2 class="name">20</h2>
        <h3 class="sub-name">mbps</h3>
      </div>
            
      <div class="title">Internet ilimitado 100% fibra óptica</div>
      <div class="actions">
        <!--h2><a href="#"><h1>12</h1><small>Followers</small></a></h2-->
        <!--h2><a href="#"><h1>1000</h1><small>Following</small></a></h2-->
        <div class="precio">
          <h3>S/.</h3>
          <h2>59 </h2>
        </div>
  ...
  <div class="flex flex-row justify-center items-center" style="padding: 20px;">
    <div class="service-card">
      <div class="banner">
      <h1 style="margin:auto; font-size:3rem; color:white;">Plan B</h1>
      </div>
  ...
  <div class="flex flex-row justify-center items-center" style="padding: 20px;">
    <div class="service-card">
      <div class="banner">
      <h1 style="margin:auto; font-size:3rem; color:white;">Plan C</h1>
      </div>
